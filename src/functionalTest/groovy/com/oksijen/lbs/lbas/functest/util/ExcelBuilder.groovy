...
class ExcelBuilder {
    ...
    def propertyMissing(String name) { cell(name) }
    ...
    static void main(String[] args) {
    	...
    	println "$currentDir"
    	new ExcelBuilder("${currentDir}\\src\\functionalTest\\resources\\TestParams.xls").eachLine {
		  println "First row ${it.rowNum} : ${cell(0)} = ${cell(1)}"
		}
    }
}
